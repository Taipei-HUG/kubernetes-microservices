...
curl --silent -Lo kubectl curl -LO https://storage.googleapis.com/kubernetes-release/release/1.17.4/bin/$HOST_OS/amd64/kubectl && chmod +x kubectl && mv kubectl ~/bin/
echo 'kubectl Done.'

curl --silent -Lo aws-iam-authenticator https://amazon-eks.s3-us-west-2.amazonaws.com/1.11.5/2018-12-06/bin/$HOST_OS/amd64/aws-iam-authenticator && chmod +x aws-iam-authenticator
